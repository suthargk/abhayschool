...
export const columns = [
  {
    accessorKey: "title",
    header: ({ column }) => {
      return <div className="font-light text-xs">Title</div>;
    },
    cell: ({ row }) => {
      return (
...

  {
    ...
    header: ({ column }) => {
      return <div className="font-light text-xs">Created On</div>;
    },
    cell: ({ row }) => {
      return (
  ...
  },
  {
    accessorKey: "action",
    header: ({ column }) => {
      return <div className="font-light text-xs">Action</div>;
    },
    cell: ({ row }) => {
      return (
